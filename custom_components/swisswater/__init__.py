"""
Custom integration to integrate Swiss Water with Home Assistant.

For more details about this integration, please refer to
https://github.com/keachi/hass-swisswater
"""
...
from .data import SwissWaterData
...
async def async_setup_entry(
    ...
    entry.runtime_data = SwissWaterData(
